...
<head>
    ...
    <style>
        body {
            background: #f8d7e8; /* pink muda */
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            padding: 1rem;
        }
        header {
            background-color: #5a2a6f; /* ungu tua */
            color: white;
            padding: 1.5rem;
            text-align: center;
            font-weight: 700;
        ...
        .form-section {
            flex: 1 1 320px;
            background: #fce4f2; /* pink pastel */
            padding: 1.8rem 1.4rem;
            border-radius: 12px;
            box-shadow: inset 0 0 10px rgb(90 42 111 / 0.1);
            min-width: 300px;
        }
        .form-section h2 {
            color: #5a2a6f;
        ...
        .table-section {
            ...
            border-radius: 12px;
            padding: 1rem;
            box-shadow: 0 8px 20px rgb(90 42 111 / 0.05);
            overflow-x: auto;
        }
        h2.table-title {
            color: #5a2a6f;
